...
enum parameters {TAO, KCTE, LAMBDA, DELTA, ETA, EXTERNAL_FORCE_X,EXTERNAL_FORCE_Y};
...
class mesh{
    ...
    public:
        void setParameters(float tao,float k, float lambda, float delta, float eta, float f_x, float f_y){
            parameters[TAO] = tao;
            parameters[KCTE] = k;
